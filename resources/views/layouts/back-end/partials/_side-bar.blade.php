            ...
            <div class="navbar-vertical-footer-offset pb-0">
                <div class="navbar-brand-wrapper justify-content-between">
                    ...
                    <a class="navbar-brand" href="{{route('admin.dashboard')}}" aria-label="Front">
                        <img style="max-width: 105px;max-height: 150px;margin-left: 45px;" onerror="this.src='{{asset('public/assets/back-end/img/160x160/img1.jpg')}}'" class="navbar-brand-logo-mini for-web-logo"
...
{{--    
    ...
    @endif
                    ...
                    @if(\App\CPU\Helpers::module_permission_check('report'))
                        ...
                        <!-- End Pages -->
                    @endif
                        <!-- <li class="nav-item {{Request::is('admin/camp-inquiery')?'active':''}}">
                            <a class="nav-link " href="{{route('admin.camp-inquiery')}}"
                                title="Camp Inquiery">
                                <span class="tio-circle nav-indicator-icon"></span>
                                <span class="text-truncate">{{trans('messages.camp')}}</span>
                            </a>
                        </li> -->
                        
                       <li class="nav-item">
                            <small class="nav-subtitle" title="Documentation">{{trans('messages.camp_info')}}</small>
                            <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                        </li>

                        <!-- Pages -->
                        <li class="navbar-vertical-aside-has-menu {{Request::is('admin/camp*')?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
                               title="Pages">
                                <i class="tio-report-outlined nav-icon"></i>
                                <span
                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{trans('messages.camp')}}</span>
                            </a>
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display: {{Request::is('admin/camp*')?'block':'none'}}">
                                <li class="nav-item {{Request::is('admin/camp/inquiery-list')?'active':''}}">
                                    <a class="nav-link " href="{{route('admin.camp.inquiery-list')}}"
                                       title="{{trans('messages.camp_inquiries_list')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">{{trans('messages.camp_inquiries_list')}}</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item">
                            <small class="nav-subtitle" title="Documentation">{{trans('messages.Appointment_details')}}</small>
                            <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                        </li>

                        <!-- Pages -->
                        <li class="navbar-vertical-aside-has-menu {{Request::is('admin/appointment*')?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
                               title="Pages">
                                <i class="tio-report-outlined nav-icon"></i>
                                <span
                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{trans('messages.appointment')}}</span>
                            </a>
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display: {{Request::is('admin/appointment*')?'block':'none'}}">
                                <li class="nav-item {{Request::is('admin/appointment/appointment-list')?'active':''}}">
                                    <a class="nav-link " href="{{route('admin.appointment.appointment-list')}}"
                                       title="{{trans('messages.appointment_list')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">{{trans('messages.appointment_list')}}</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
