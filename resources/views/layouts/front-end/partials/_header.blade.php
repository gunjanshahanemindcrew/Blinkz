        ...
        <div class="container ">
            <div>
                @php
                    ...
                    \App\CPU\Helpers::currency_load();                    $currency_code = "Rupi";
                    $currency_symbol= "?";
                    if ($currency_symbol=="")
                    {
    ...
    <div class="navbar-sticky bg-light mobile-head">
        <div class="navbar navbar-expand-md navbar-light">
            <div class="container ">
                ...
                <a class="navbar-brand d-sm-none mr-2" href="{{route('home')}}" style="min-width: 4.625rem;">
                    <img width="100"
            ...
            <div class="container">
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown {{request()->is('/')?'active':''}}">
                            <a class="nav-link" href="{{route('eye-test-camp')}}" target="_blank">{{ trans('messages.camp')}}</a>
                        </li>
                        <!-- <li class="nav-item dropdown">
                        ...
                        <li class="nav-item">
                            <div class="dropdown">
                                <button class="btn dropdown-toggle" type="button" id="dropdownMenuButton"
                                    ...
                                    <b>{{ trans('messages.doctor')}}  {{ trans('messages.zone')}} </b>
                                </button>
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton"
                                     style="min-width: 165px !important;">
                                    <a class="dropdown-item" href="{{route('appointment.slot-availability')}}">
                                        <b>{{ trans('messages.book_appointment')}}</b>
                                    </a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="{{ route('our-clinic')}}">
                                        <b>{{ trans('messages.our_clinic')}}</b>
                                    </a>
                                    <a class="dropdown-item" href="{{route('faq.faq')}}">
                                        <b>{{ trans('messages.faq')}}</b>
                                    </a>
                                    {{--<div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="{{route('seller.auth.login')}}">
                                        <b>{{ trans('messages.Seller')}}  {{ trans('messages.login')}} </b>
                                    </a>
                                     <a class="dropdown-item" href="{{route('howtosell')}}">
                                        <b>How To Sell </b>
                                    </a>
                                     <a class="dropdown-item" href="{{route('shoot')}}">
                                        <b>Shoot Your Products </b>
                                    </a>--}}
                                </div>
                            </div>
                        </li>
