    ...
    <table class="table table-bordered">
        ...
        @foreach ($combinations as $key => $combination)
            <tr>
                ...
                <td>
                    <input type="number" name="price_{{ $combination['type'] }}" value="{{ $combination['price'] }}" min="0" step="0.01"
                ...
                <td>
                    <input type="number" name="qty_{{ $combination['type'] }}" value="10" min="0" step="1" class="form-control"
                           required>
                </td>
            </tr>
        @endforeach
