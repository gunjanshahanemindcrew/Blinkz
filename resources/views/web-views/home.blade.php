...
@section('content')
    ...
    <section class="container">
        <div class="row">
        <div class="col-md-5">
        <img class="mr-2" src="{{asset('public/camp')}}/frames-as-per-faceshape.jpg" alt="Eng">
        </div>
        <div class="col-md-7">
    {{--flash deal--}}
    ...
    <section class="container mt-5">
        ...
        <div class="row pt-2 mx-n2">
            @foreach($categories as $category)
                <div class="col-lg-3 col-md-4 col-sm-4 col-6 px-2 mb-3 text-center inline_product"
                     style="cursor: pointer"
