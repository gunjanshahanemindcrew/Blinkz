...
class LanguageController extends Controller
{
    ...
    {
        $language=BusinessSetting::where('type','language')->get();
        $lang_values = [];
        foreach ($language as $key => $value) {
            $lang_values =  json_decode($value->value, true);
        }
        return view('admin-views.business-settings.language.index', compact('lang_values'));
    }
